import { Permission } from "../models/types/permissions.type";

export interface PermissionsUIConfig {
  label: string;
  group: string;
}

export const PERMISSIONS_UI: Record<Permission, PermissionsUIConfig> = {
  // =========================

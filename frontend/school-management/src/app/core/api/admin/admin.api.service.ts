...
import { UpdatePermissionsBulkResponse } from '../../../features/admin/models/response/permissions/update-permissions-bulk-response.model';
...
import { ActivateUsers, ChangeUsersStatus, DeleteUsers, DisableUsers, TemporaryDisableUsers } from "../../../features/admin/models/response/change-users-status-response.model";
import { UpdateRolesBulk } from "../../../features/admin/models/request/update-roles-bulk.model";
import { UpdateRolesBulkResponse, UsersRoles } from "../../../features/admin/models/response/permissions/update-roles-bulk-response.model";
...
import { UsersPermissions } from "../../../features/admin/models/response/permissions/update-permissions-bulk-response.model";
import { PermissionsByCurps, PermissionsByCurpsResponse } from '../../../features/admin/models/response/permissions/permissions-by-curp-response.model';
import { PermissionsByRole, PermissionsByRoleResponse } from '../../../features/admin/models/response/permissions/permissions-by-role-response.model';
import { Permission } from '../../../features/admin/models/response/permissions/permissions.model';
import { PermissionsByUserResponse } from '../../../features/admin/models/response/permissions/permissions-by-user-response.model';

...
use App\Core\Application\Services\Events\EmailEventManager;
use App\Core\Application\Services\Events\PaymentEventManager;
use App\Core\Application\Services\Events\ReconciliationEventManager;
use App\Core\Application\Services\Reconciliation\PaymentReconciliationService;
...
use App\Core\Infraestructure\Repositories\Command\Events\EloquentEmailEventRepository;
use App\Core\Infraestructure\Repositories\Command\Events\EloquentPaymentEventRepository;
use App\Core\Infraestructure\Repositories\Command\Events\EloquentReconciliationEventRepository;
...
use App\Core\Infraestructure\Repositories\Query\Events\EloquentEmailEventQueryRepository;
use App\Core\Infraestructure\Repositories\Query\Events\EloquentPaymentEventQueryRepository;
use App\Core\Infraestructure\Repositories\Query\Events\EloquentReconciliationEventQueryRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(EmailEventRepInterface::class, EloquentEmailEventRepository::class);
        $this->app->bind(EmailEventQueryRepInterface::class, EloquentEmailEventQueryRepository::class);
        $this->app->bind(ReconciliationEventRepInterface::class, EloquentReconciliationEventRepository::class);
        $this->app->bind(ReconciliationEventQueryRepInterface::class, EloquentReconciliationEventQueryRepository::class);
        $this->app->bind(PaymentEventManagerInterface::class, PaymentEventManager::class);
        $this->app->bind(EmailEventManagerInterface::class, EmailEventManager::class);
        $this->app->bind(ReconciliationEventManagerInterface::class, ReconciliationEventManager::class);
        $this->app->bind(PaymentReconciliationServiceInterface::class, PaymentReconciliationService::class);
